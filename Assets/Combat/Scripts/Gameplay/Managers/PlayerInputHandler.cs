...
namespace Unity.FPS.Gameplay
{
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            {
                Debug.LogError("InputSystem.actions is null. Please ensure a default Input Action Asset is set in Project Settings > Input System Package.");
                return;
            }
        ...
        {
            if (CanProcessInput() && m_MoveAction != null)
            {
        ...
        {
            if (!CanProcessInput() || m_LookAction == null)
                return 0.0f;
        ...
        {
            if (CanProcessInput() && m_JumpAction != null)
            {
        ...
        {
            if (CanProcessInput() && m_FireAction != null)
            {
        ...
        {
            if (CanProcessInput() && m_AimAction != null)
            {
        ...
        {
            if (CanProcessInput() && m_SprintAction != null)
            {
        ...
        {
            if (CanProcessInput() && m_CrouchAction != null)
            {
        ...
        {
            if (CanProcessInput() && m_ReloadAction != null)
            {
        ...
        {
            if (CanProcessInput() && m_NextWeaponAction != null)
            {
