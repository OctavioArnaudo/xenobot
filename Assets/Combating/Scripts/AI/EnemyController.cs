...
namespace Unity.FPS.AI
{
    ...
    public class EnemyController : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            DetectionModule = detectionModules.Length > 0 ? detectionModules[0] : null;
        }
        ...
        void Start()
        {
            ...
            {
                DebugUtility.HandleErrorIfNoComponentFound<DetectionModule, EnemyController>(0, this, gameObject);
            }
        ...
        void Update()
        {
            ...
            if (OnHitBodyGradient != null && m_BodyFlashMaterialPropertyBlock != null)
            {
