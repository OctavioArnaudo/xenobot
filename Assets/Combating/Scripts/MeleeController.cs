...
namespace Combating.Scripts {
    ...
    public class MeleeController : NetworkBehaviour, IPlayer {
        ...
        // Debe coincidir EXACTAMENTE con el parámetro Trigger "meleeAttack" del Animator Controller
        ...
        /// <summary>
        /// Busca y cachea el Animator del jugador/enemigo y verifica si tiene el parámetro "meleeAttack".
        /// </summary>
        private void RefreshAnimatorReference() {
            if (animator == null) {
                animator = (_hub != null) ? _hub.GetComponentInChildren<Animator>() : GetComponentInChildren<Animator>();
            }
        ...
        /// <summary>
        /// Dispara el Trigger "meleeAttack" en el Animator.
        /// </summary>
